...
export const filterSearch = async(searchText:string):Promise<PokemonDTO[] | undefined>=>{
    try{
...
export const getPokemonList = async(pageNumber:number):Promise<PokemonDTO[]>=>{
...
export const getPokemonDetail = async(id:string):Promise<PokemonDetailLocal> =>{
    ...
    return transformPokemonDetail(pokemonDetail);
}

const transformPokemonDetail = (data:PokemonDetailDTO):PokemonDetailLocal =>{
